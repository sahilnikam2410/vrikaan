    ...
    <div style={{ minHeight: "100vh", background: T.bg, fontFamily: "'Vrikaan Sans', sans-serif" }}>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 24px 80px" }}>
        ...
        {files.length > 0 && (
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: 22, fontWeight: 800, color: riskColor, fontFamily: "'Vrikaan Sans', sans-serif" }}>{riskLevel}</div>
            </div>
            ...
            {[
              ...
              <div key={s.l} style={{ textAlign: "center", padding: "10px 8px" }}>
                <div style={{ fontSize: 20, fontWeight: 800, color: s.c, fontFamily: "'Vrikaan Sans', sans-serif" }}>{s.v}</div>
        ...
        <section style={{
          ...
          <h2 style={{
            fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 22, color: T.white, margin: "0 0 8px",
...
function NativeStat({ label, value, color }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: 20, fontWeight: 800, color, fontFamily: "'Vrikaan Sans', sans-serif" }}>{value}</div>
