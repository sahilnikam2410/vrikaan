...
const SOCIALS = [
  { name: "X", url: "https://x.com/vrikaan", svg: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
  { name: "LinkedIn", url: "https://www.linkedin.com/company/vrikaan-ai-cybersecurity", svg: "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" },
  { name: "Instagram", url: "https://www.instagram.com/vrikaan_official/", svg: "M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" },
  { name: "GitHub", url: "https://github.com/sahilnikam2410/vrikaan", svg: "M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.009-.866-.013-1.7-2.782.604-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.464-1.11-1.464-.908-.62.069-.607.069-.607 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.831.092-.646.35-1.086.636-1.337-2.22-.252-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0112 6.836c.85.004 1.705.115 2.504.337 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.138 20.163 22 16.418 22 12c0-5.523-4.477-10-10-10z" },
];
...
const inputBase = {
  ...
  borderRadius: 10, color: T.white, fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 14,
...
export default function Contact() {
  ...
  const heading = (size) => ({ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: size, fontWeight: 700, letterSpacing: "-0.03em", color: T.white, margin: 0 });
    ...
    <div style={{ background: T.bg, minHeight: "100vh", color: T.white, fontFamily: "'Vrikaan Sans', sans-serif" }}>
          ...
          <div style={{ ...cardStyle, padding: 36 }}>
            {sent ? (
              <div style={{ textAlign: "center", padding: "48px 20px" }}>
                ...
                <button onClick={resetForm} style={{ padding: "12px 28px", background: `${T.accent}10`, border: `1px solid ${T.accent}25`, borderRadius: 10, color: T.accentSoft, cursor: "pointer", fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 14, fontWeight: 600, transition: "all 0.3s" }}>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                  ...
                  <button type="submit" disabled={sending}
                    style={{ padding: "15px 36px", background: sending ? T.mutedDark : `linear-gradient(135deg, ${T.accent}, ${T.accentSoft})`, color: "#fff", border: "none", borderRadius: 10, fontSize: 15, fontWeight: 600, cursor: sending ? "not-allowed" : "pointer", fontFamily: "'Vrikaan Sans', sans-serif", transition: "all 0.3s", opacity: sending ? 0.7 : 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
                    {sending ? (
                      <>
              ...
              <>
                ...
                <form onSubmit={handleVulnSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
                    <span style={{ fontSize: 12, color: T.mutedDark, fontFamily: "'Vrikaan Mono', monospace" }}>PGP key available at /security.txt</span>
                    <button type="submit" style={{ padding: "12px 28px", background: `${T.red}14`, border: `1px solid ${T.red}30`, borderRadius: 10, color: T.red, cursor: "pointer", fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 14, fontWeight: 600, transition: "all 0.3s" }}
          ...
          {nlSubmitted ? (
            ...
            <>
              ...
              <form onSubmit={handleNewsletterSubmit} style={{ display: "flex", gap: 12, maxWidth: 480, margin: "0 auto", flexWrap: "wrap", justifyContent: "center" }} className="nl-form">
                ...
                <button type="submit" style={{ padding: "14px 32px", background: `linear-gradient(135deg, ${T.accent}, ${T.accentSoft})`, color: "#fff", border: "none", borderRadius: 10, fontSize: 14, fontWeight: 600, cursor: "pointer", fontFamily: "'Vrikaan Sans', sans-serif", transition: "all 0.3s", whiteSpace: "nowrap" }}>
                  Subscribe
                </button>
              </form>
      ...
      <section style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px 80px" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ color: T.muted, fontSize: 15, lineHeight: 1.7 }}>Headquartered in Nashik, India — protecting users for everyday Indians.</p>
        </div>
        <div className="contact-presence-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
          {[
            ...
            <div key={i} style={{ ...cardStyle, textAlign: "center", padding: "28px 20px" }}>
              ...
              <div style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 24, fontWeight: 800, color: T.cyan, margin: "8px 0 4px" }}>{r.users}</div>
