...
export default function BlogPost() {
  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh", fontFamily: "'Vrikaan Sans', sans-serif", color: T.white }}>
      <SEO
        title={article.title}
        description={article.excerpt}
        path={`/blog/${slug}`}
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 24px 60px" }}>
        <div style={{ display: "flex", gap: 40, alignItems: "flex-start" }}>
          ...
          <article className="bp-main" style={{ flex: 1, maxWidth: 780 }} ref={contentRef}>
            ...
            {/* Title */}
            <h1 className="bp-title" style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 40, fontWeight: 800, color: T.white, margin: "0 0 20px", lineHeight: 1.15, letterSpacing: "-0.02em" }}>
              {article.title}
            </h1>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 0", borderTop: `1px solid ${T.border}`, borderBottom: `1px solid ${T.border}`, marginBottom: 36, flexWrap: "wrap", gap: 12 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ width: 44, height: 44, borderRadius: "50%", background: `${article.author.color}20`, border: `2px solid ${article.author.color}40`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 700, color: article.author.color, fontFamily: "'Vrikaan Sans'" }}>
            ...
            <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 14, padding: "16px 20px", marginBottom: 32 }} className="bp-toc-mobile">
              <h4 style={{ fontFamily: "'Vrikaan Sans'", fontSize: 13, fontWeight: 700, color: T.mutedDark, margin: "0 0 12px", letterSpacing: 1, textTransform: "uppercase" }}>
                Table of Contents
              </h4>
            ...
            {article.content.map((section, i) => (
              <section key={i} data-section={i} style={{ marginBottom: 36 }}>
                <h2 style={{ fontFamily: "'Vrikaan Sans'", fontSize: 24, fontWeight: 700, color: T.white, margin: "0 0 14px", paddingTop: 8, letterSpacing: "-0.01em" }}>
                  {section.heading}
                </h2>
            ...
            <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 16, padding: 28, marginTop: 12, marginBottom: 48, display: "flex", gap: 20, alignItems: "flex-start", flexWrap: "wrap" }}>
              <div style={{ width: 56, height: 56, borderRadius: "50%", background: `${article.author.color}20`, border: `2px solid ${article.author.color}40`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, fontWeight: 700, color: article.author.color, fontFamily: "'Vrikaan Sans'", flexShrink: 0 }}>
                {article.author.initials}
              </div>
              <div style={{ flex: 1, minWidth: 200 }}>
                ...
                <div style={{ fontSize: 18, fontWeight: 700, color: T.white, fontFamily: "'Vrikaan Sans'", marginBottom: 8 }}>{article.author.name}</div>
            ...
            <div style={{
              ...
              <h3 style={{ fontFamily: "'Vrikaan Sans'", fontSize: 22, fontWeight: 700, color: T.white, margin: "0 0 10px" }}>
            ...
            {related.length > 0 && (
              <div>
                <h3 style={{ fontFamily: "'Vrikaan Sans'", fontSize: 22, fontWeight: 700, color: T.white, marginBottom: 20 }}>
                  Related Articles
                </h3>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ padding: 16, flex: 1 }}>
                          <h4 style={{ fontFamily: "'Vrikaan Sans'", fontSize: 14, fontWeight: 700, color: T.white, margin: "0 0 6px", lineHeight: 1.4 }}>
                            {a.title}
                          </h4>
          ...
          <aside className="bp-sidebar" style={{ width: 220, flexShrink: 0, position: "sticky", top: 100, alignSelf: "flex-start" }}>
            <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 14, padding: 20 }}>
              <h4 style={{ fontFamily: "'Vrikaan Sans'", fontSize: 13, fontWeight: 700, color: T.mutedDark, margin: "0 0 14px", letterSpacing: 1, textTransform: "uppercase" }}>Contents</h4>
              {article.content.map((sec, i) => (
                <div
                  key={i}
                  onClick={() => scrollToSection(i)}
