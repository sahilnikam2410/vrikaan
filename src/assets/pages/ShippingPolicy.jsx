  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh", color: T.white, fontFamily: "'Vrikaan Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "120px 24px 80px" }}>
        ...
        <h1 style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 44, fontWeight: 700, letterSpacing: "-0.03em", margin: "0 0 12px" }}>Shipping Policy</h1>
        <p style={{ color: T.mutedDark, fontSize: 14, marginBottom: 48 }}>Last updated: April 12, 2026</p>

        {[
          { title: "1. Digital Delivery", content: "VRIKAAN is a fully digital cybersecurity platform. All our products, services, and subscriptions are delivered electronically via our website. There are no physical products involved, and therefore no physical shipping is required." },
          ...
          { title: "3. Account Activation", content: "After completing your purchase, your account will be automatically upgraded to the selected plan. You can access all premium features by logging into your account at vrikaan.com. A confirmation email will be sent to your registered email address." },
          ...
          { title: "8. Contact Us", content: "If you have any questions about our delivery process or face any issues accessing your subscription, please contact us at hello@vrikaan.com or call +91 9607742410. Our support team is available 24/7." },
        ].map((s, i) => (
