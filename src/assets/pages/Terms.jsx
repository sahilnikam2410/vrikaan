  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh", color: T.white, fontFamily: "'Vrikaan Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "120px 24px 80px" }}>
        ...
        <h1 style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 44, fontWeight: 700, letterSpacing: "-0.03em", margin: "0 0 12px" }}>Terms of Service</h1>
        ...
        {[
          ...
          { title: "11. Contact", content: "For questions about these Terms of Service, contact us at hello@vrikaan.com or call +91 9607742410." },
        ].map((s, i) => (
