    ...
    <div style={{ background: T.bg, minHeight: "100vh", color: T.white, fontFamily: "'Hanken Grotesk', sans-serif" }}>
      ...
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "120px 24px 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h1 style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: "clamp(40px, 5vw, 56px)", fontWeight: 700, letterSpacing: "-0.03em", margin: "0 0 16px" }}>Meet the Founders</h1>
          ...
          <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 20, padding: 36, backdropFilter: "blur(8px)" }}>
            <div style={{ display: "flex", gap: 18, alignItems: "flex-start", marginBottom: 20 }}>
              <div style={{ width: 78, height: 78, borderRadius: 20, background: "linear-gradient(135deg, rgba(99,102,241,0.18), rgba(20,227,197,0.08))", border: "1px solid rgba(99,102,241,0.25)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <span style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 36, fontWeight: 300, color: T.white }}>S</span>
              </div>
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <h2 style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 22, fontWeight: 700, margin: 0 }}>Sahil Anil Nikam</h2>
          ...
          <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 20, padding: 36, backdropFilter: "blur(8px)" }}>
            <div style={{ display: "flex", gap: 18, alignItems: "flex-start", marginBottom: 20 }}>
              <div style={{ width: 78, height: 78, borderRadius: 20, background: "linear-gradient(135deg, rgba(20,227,197,0.18), rgba(99,102,241,0.08))", border: "1px solid rgba(20,227,197,0.25)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <span style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 36, fontWeight: 300, color: T.white }}>K</span>
              </div>
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <h2 style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 22, fontWeight: 700, margin: 0 }}>Khushi Ishwar Raigade</h2>
        ...
        <div style={{ marginBottom: 56, background: "linear-gradient(135deg, rgba(99,102,241,0.08), rgba(20,227,197,0.04))", border: `1px solid ${T.border}`, borderRadius: 18, padding: "28px 32px" }}>
          ...
          <h3 style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 20, fontWeight: 700, margin: "0 0 8px" }}>Reach a founder personally</h3>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32, marginBottom: 64 }}>
          {[
            ...
            <div key={i} style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 16, padding: "32px 36px" }}>
              <h3 style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 20, fontWeight: 600, margin: "0 0 12px", color: T.cyan }}>{s.title}</h3>
        ...
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          <h2 style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 28, fontWeight: 700, margin: "0 0 32px", letterSpacing: "-0.02em" }}>Core Beliefs</h2>
          <div className="resp-grid-3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
            {[
              ...
              <div key={i} style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 14, padding: "28px 20px" }}>
                <div style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 16, fontWeight: 600, color: T.white, marginBottom: 6 }}>{b.val}</div>
        ...
        <div style={{ textAlign: "center", padding: "48px 32px", background: "linear-gradient(135deg, rgba(99,102,241,0.06), rgba(20,227,197,0.03))", border: `1px solid rgba(99,102,241,0.1)`, borderRadius: 20 }}>
          <h2 style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 28, fontWeight: 700, margin: "0 0 12px" }}>Join the Mission</h2>
