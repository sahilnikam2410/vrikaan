    ...
    <div style={{ minHeight: "100vh", background: T.bg, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <header style={{
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 900, margin: "0 auto" }}>
          ...
          <h1 style={{
            fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(36px, 6vw, 64px)",
      ...
      <section style={{ maxWidth: 1000, margin: "60px auto 0", padding: "0 24px 60px" }}>
        <div style={{ textAlign: "center", marginBottom: 30 }}>
          <h2 style={{
            fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(28px, 4vw, 38px)",
      ...
      <section style={{ maxWidth: 1100, margin: "30px auto 0", padding: "0 24px 60px" }}>
        <div style={{ textAlign: "center", marginBottom: 30 }}>
          <h2 style={{
            fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(26px, 4vw, 36px)",
            fontWeight: 800, color: T.white, margin: 0,
