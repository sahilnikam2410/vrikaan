  ...
  return (
    <div style={{ position: "relative", width: size, height: size }}>
      ...
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        <span style={{ fontSize: 42, fontWeight: 700, fontFamily: "'Vrikaan Sans'", color }}>{anim}</span>
          ...
          <section style={{ padding: "0 20px 50px" }}>
            <div style={wrap}>
              ...
              <div style={{ ...sty.card, textAlign: "center", padding: "40px 24px", borderColor: results.breaches.length > 4 ? `${T.red}30` : results.breaches.length > 2 ? `${T.orange}30` : `${T.yellow}30` }}>
                <div style={{ fontSize: 56, fontWeight: 800, fontFamily: "'Vrikaan Sans'", color: results.breaches.length > 4 ? T.red : results.breaches.length > 2 ? T.orange : T.yellow }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                {results.breaches.map((b, i) => (
                  <div key={b.name} style={{ ...sty.card, display: "flex", gap: 20, alignItems: "flex-start", animation: `dwm-slideIn 0.4s ease ${i * 0.1}s both`, flexWrap: "wrap" }}>
                    {/* Logo placeholder */}
                    <div style={{ width: 52, height: 52, borderRadius: 12, background: `${b.color}20`, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: 16, color: b.color, fontFamily: "'Vrikaan Sans'", flexShrink: 0 }}>
                      {b.icon}
                    </div>

                    <div style={{ flex: 1, minWidth: 200 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", marginBottom: 8 }}>
                        <span style={{ fontSize: 17, fontWeight: 700, color: T.white, fontFamily: "'Vrikaan Sans'" }}>{b.name}</span>
            ...
            <div style={sty.card}>
              ...
              {[
                ...
                <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "6px 0", borderBottom: i < 2 ? `1px solid ${T.border}` : "none" }}>
                  ...
                  <span style={{ fontSize: 16, fontWeight: 700, fontFamily: "'Vrikaan Sans'", color: s.color }}>{s.value}</span>
                </div>
              ))}
            </div>
          </div>
