    ...
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 2, textAlign: "center", maxWidth: 760, width: "100%" }}>
        ...
        {step === 1 && (
          <div style={{ animation: "fadeInUp 0.6s ease" }}>
            <h2 style={{
              fontFamily: "'Vrikaan Sans'", fontSize: 28, fontWeight: 800,
            ...
            <div>
              <button onClick={() => setStep(3)} style={{
                ...
                cursor: "pointer", fontFamily: "'Vrikaan Sans'", marginTop: 16,
              }}>
                Skip to certificate →
              </button>
            </div>
        ...
        {step === 2 && (
          <div style={{ animation: "fadeInUp 0.6s ease" }}>
            <h2 style={{ fontFamily: "'Vrikaan Sans'", fontSize: 28, fontWeight: 800, color: T.white, marginBottom: 8 }}>
            ...
            <div style={{ maxWidth: 420, margin: "0 auto 28px" }}>
              ...
              <div style={{
                fontFamily: "'Vrikaan Mono', monospace", fontSize: 14, color: T.cyan,
              }}>{checkProgress}%</div>
            </div>
            <div style={{
          ...
          <div style={{ animation: "fadeInUp 0.6s ease" }}>
            ...
            <div className="welcome-stats" style={{
              ...
              {[
                ...
                <div key={s.label} style={{ textAlign: "center" }}>
                  <div style={{ fontSize: 24, fontWeight: 800, color: s.color, fontFamily: "'Vrikaan Sans'" }}>{s.value}</div>
            ...
            {!certImage && (
              <div style={{
                ...
                <h3 style={{ fontSize: 22, fontWeight: 700, color: T.white, fontFamily: "'Vrikaan Sans'", marginBottom: 8 }}>
            ...
            {!certImage && (
              <button onClick={() => navigate("/dashboard")} style={{
                ...
                cursor: "pointer", fontFamily: "'Vrikaan Sans'", marginTop: 12,
              }}>
                Skip to dashboard →
              </button>
            )}
