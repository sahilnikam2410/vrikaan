...
const T = { bg: "#060a14", white: "#f1f5f9", muted: "#94a3b8", mutedDark: "#64748b", accent: "#6366f1", cyan: "#14b8a6", border: "rgba(148,163,184,0.08)" };
  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh", color: T.white, fontFamily: "'Vrikaan Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "120px 24px 80px" }}>
        ...
        <h1 style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 44, fontWeight: 700, letterSpacing: "-0.03em", margin: "0 0 12px" }}>Privacy Policy</h1>
        ...
        {[
          ...
          { title: "9. Chatbot Assistants (WhatsApp & Telegram)", content: "When you message our WhatsApp or Telegram scam-check bots, the text you send is processed by our AI in real time to return a scam verdict. We store an anonymized scam 'fingerprint' — such as a reused fraudulent UPI ID, phone number, or link extracted from the message — to warn other users through our Scam DNA network. We do not store your chat history or contacts, and we never sell bot data. Please do not send passwords, OTPs, or full card numbers to the bots. You can stop at any time by deleting the chat or blocking the bot." },
          { title: "9a. Herd immunity alerts (WhatsApp)", content: "If you check a message with our WhatsApp bot and the result is inconclusive, we store your WhatsApp number against that message's fingerprint so we can warn you later if other people report the same scam. This is the one case where a number is linked to a message you checked. The record holds only your number, the channel, and the risk score at the time — not the message text, and it is never used for marketing. It is deleted as soon as we send you an alert, or automatically after 90 days if the message is never confirmed as a scam, whichever comes first. To opt out, message 'alert off' to the bot; to remove a stored number immediately, email hello@vrikaan.com." },
          { title: "10. Changes to This Policy", content: "We may update this Privacy Policy from time to time. We will notify you of any material changes by email or through a prominent notice on our platform. Your continued use of Vrikaan after changes are posted constitutes acceptance of the updated policy." },
          { title: "11. Contact Us", content: "If you have questions about this Privacy Policy or our data practices, contact us at hello@vrikaan.com or write to: VRIKAAN, Nashik, Maharashtra, India." },
        ].map((s, i) => (
          <div key={i} style={{ marginBottom: 36 }}>
            <h2 style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 20, fontWeight: 600, color: T.white, margin: "0 0 12px" }}>{s.title}</h2>
