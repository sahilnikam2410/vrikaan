...
const sty = {
  ...
  btn: (bg, clr) => ({ padding: "12px 28px", background: bg, border: "none", borderRadius: 8, color: clr || "#fff", fontSize: 14, fontWeight: 600, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 8, fontFamily: "'Vrikaan Sans'", transition: "all 0.2s" }),
  input: { width: "100%", padding: "14px 18px", background: "rgba(15,23,42,0.6)", border: `1px solid ${T.border}`, borderRadius: 8, color: T.white, fontSize: 14, outline: "none", boxSizing: "border-box", fontFamily: "'Vrikaan Sans'" },
};
...
export default function PasswordChecker() {
  ...
  const h2 = { fontSize: 28, fontWeight: 700, fontFamily: "'Vrikaan Sans'", color: T.white, margin: "0 0 8px" };
              ...
              <div style={{ ...sty.card, textAlign: "center", padding: "40px 24px", borderColor: results.breached ? `${T.red}30` : `${T.green}30` }}>
                {results.breached ? (
                  <>
                    ...
                    <div style={{ fontSize: 32, fontWeight: 800, fontFamily: "'Vrikaan Sans'", color: T.red }}>
                      Password Compromised
                    </div>
                    <p style={{ fontSize: 15, color: T.muted, margin: "12px 0 0", lineHeight: 1.7 }}>
                      This password has been seen <span style={{ color: T.red, fontWeight: 700, fontFamily: "'Vrikaan Sans'" }}>{results.count.toLocaleString()}</span> time{results.count !== 1 ? "s" : ""} in data breaches.
                  ...
                  <>
                    ...
                    <div style={{ fontSize: 32, fontWeight: 800, fontFamily: "'Vrikaan Sans'", color: T.green }}>
                      Safe — Not Found
                    </div>
                    <p style={{ fontSize: 15, color: T.muted, margin: "12px 0 0", lineHeight: 1.7 }}>
      ...
      <section style={{ padding: "0 20px 80px" }}>
        <div style={wrap}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
            {[
              ...
              <div key={i} style={{ ...sty.card, animation: `pwc-slideIn 0.4s ease ${i * 0.1}s both` }}>
                <div style={{ width: 40, height: 40, borderRadius: 10, background: `${item.color}12`, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: 16, color: item.color, fontFamily: "'Vrikaan Sans'", marginBottom: 16 }}>
                  {item.step}
                </div>
                <div style={{ fontSize: 16, fontWeight: 700, color: T.white, fontFamily: "'Vrikaan Sans'", marginBottom: 8 }}>{item.title}</div>
          ...
          <div style={{ ...sty.card, marginTop: 24, display: "flex", gap: 16, alignItems: "flex-start", borderColor: `${T.green}20` }}>
            ...
            <div>
              <div style={{ fontSize: 16, fontWeight: 700, color: T.white, fontFamily: "'Vrikaan Sans'", marginBottom: 6 }}>Your Privacy Is Protected</div>
