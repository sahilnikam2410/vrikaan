    ...
    <div style={{ minHeight: "100vh", background: T.bg, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <main style={{ maxWidth: 1180, margin: "0 auto", padding: "80px 24px 60px" }}>
        ...
        <section style={{ display: "grid", gap: 14, marginBottom: 60 }}>
          {filtered.length === 0 && (
            <div style={{
              ...
              No matching roles. Reset filters or send a speculative pitch to <a style={{ color: T.cyan }} href="mailto:hr.vrikaan@gmail.com?cc=hello@vrikaan.com">hr.vrikaan@gmail.com</a>.
            </div>
          )}
                ...
                {isOpen && (
                  <div style={{ padding: "0 24px 24px", color: T.muted }}>
                    ...
                    <div style={{
                      ...
                      <a
                        href={`mailto:hr.vrikaan@gmail.com?cc=hello@vrikaan.com&subject=${encodeURIComponent(`Application — ${job.title} — ${job.id}`)}&body=${encodeURIComponent(applyTemplate(job))}`}
        ...
        <section style={{
          ...
          <a
            href="mailto:hr.vrikaan@gmail.com?cc=hello@vrikaan.com&subject=Speculative%20pitch%20%E2%80%94%20VRIKAAN"
        ...
        <p style={{ color: T.muted, fontSize: 12, marginTop: -40, marginBottom: 60, textAlign: "center" }}>
          Tip: applying for a role? Use <strong style={{ color: T.cyan }}>hr.vrikaan@gmail.com</strong> — the Apply buttons above auto-CC <strong style={{ color: T.white }}>hello@vrikaan.com</strong> for tracking.
        </p>
