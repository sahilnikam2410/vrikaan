/**
 * Blog content and presentation constants.
 *
 * Split out of Blog.jsx so that file exports only its component. A module
 * that mixes components with plain values breaks Fast Refresh: editing the
...
// Tag cloud shown on the blog index sidebar.
export const tags = ["Encryption", "Phishing", "Malware", "Privacy", "AI", "Cloud", "IoT", "Zero Trust", "Ransomware", "VPN", "Firewall", "SIEM", "SOC", "Pentesting", "OSINT", "MFA", "DDoS", "Blockchain"];

export const authors = [
  { name: "Sahil Anil Nikam", initials: "SN", color: T.accent, bio: "Founder & CEO of VRIKAAN. SOC analyst and cybersecurity researcher based in Nashik. Builds AI-powered threat detection and incident response systems for Indian families and businesses." },
