        ...
        {result && (
          <div id="rs-result" style={{ marginTop: 40 }}>
            ...
            <div style={{ textAlign: "center", padding: "32px 24px", background: T.card, border: `1px solid ${bandColor(result.band)}40`, borderRadius: 18, marginBottom: 20 }}>
              ...
              <div style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 72, fontWeight: 800, lineHeight: 1, color: bandColor(result.band), letterSpacing: "-0.04em" }}>{result.score}<span style={{ fontSize: 28, color: T.mutedDark }}>/100</span></div>
            ...
            <div style={{ textAlign: "center", padding: "32px 28px", background: `linear-gradient(135deg, ${T.accent}10, ${T.cyan}06)`, border: `1px solid ${T.accent}22`, borderRadius: 18 }}>
              ...
              <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
                <Link to="/pricing" style={{ padding: "13px 28px", background: `linear-gradient(135deg, ${T.cyan}, ${T.accent})`, color: "#020617", borderRadius: 10, textDecoration: "none", fontSize: 14, fontWeight: 800, fontFamily: "'Vrikaan Sans', sans-serif" }}>See plans →</Link>
