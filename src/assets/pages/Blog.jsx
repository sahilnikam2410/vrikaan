...
export const T = { bg: "#060a14", white: "#f1f5f9", muted: "#94a3b8", mutedDark: "#64748b", accent: "#6366f1", cyan: "#14b8a6", ember: "#f97316", red: "#ef4444", gold: "#eab308", purple: "#a78bfa", blue: "#38bdf8", green: "#22c55e", pink: "#ec4899", border: "rgba(148,163,184,0.08)", card: "rgba(17,24,39,0.6)", surface: "#111827" };
...
export const articles = [
  {
    id: 100,
    title: "VRIKAAN India Threat Report 2026",
    category: "Research",
    readTime: "16 min read",
    date: "May 25, 2026",
    author: authors[0],
    excerpt: "Analysis of 2.84 million threat events processed for Indian users between June 2025 and April 2026. UPI fraud dominates, AI voice cloning is up 17×, and children under 14 emerged as a measurable victim class for the first time. India lost an estimated ₹13,500 crore to cybercrime in FY25–26.",
    likes: 0,
    comments: 0,
    tags: ["Threat Report", "India", "UPI Fraud", "Deepfake", "AI"],
    featured: true,
    content: [
      { heading: "Executive Summary", text: "India faces a cyber threat landscape unlike any other major economy. In FY2025–26, Indian citizens lost an estimated ₹13,500 crore to cybercrime — up 38% year-over-year. The targets are no longer enterprises behind hardened firewalls. They are everyday people: students, gig workers, homemakers, retirees, small-business owners. The weapons are no longer zero-day exploits. They are AI-cloned voices, deepfake video calls, UPI social engineering, and regulator-impersonation scripts that bypass every traditional defence. This report analyses 2.84 million threat events processed by VRIKAAN's defence network across 84 countries between June 2025 and April 2026, with deep focus on the India-specific patterns that account for 81% of our observed events." },
      { heading: "Five Key Findings", text: "1) UPI fraud now dominates. 41% of all financial loss events VRIKAAN observed in India involved UPI as the rail. Average loss per victim: ₹14,200. Median age of victim: 47.  2) AI voice cloning crossed the chasm. We observed a 17× increase in deepfake voice attacks against Indian families between Jan 2025 and March 2026. Cost per cloned voice has collapsed from $400 (2023) to under $5 (2026).  3) 'Digital arrest' scams emerged as the top single-incident loss category. Median loss: ₹4.7 lakh. The scam — impersonating CBI / RBI / NCB officials via WhatsApp video — works specifically because India's regulator UX is opaque to ordinary citizens.  4) Loan-app harassment exploded. 11 of the top 20 Android app stores hosted predatory loan apps in our sample. Recovery scripts increasingly use morphed images of victims' female family members.  5) Children under 14 became a measurable victim class for the first time. 8% of scam-recovery requests submitted to VRIKAAN in Q1 2026 named a minor as the direct victim — most commonly via in-game currency scams, fake Squad-Pay handles, and Instagram giveaway fraud." },
      { heading: "Scale of Loss", text: "The Indian Cyber Crime Coordination Centre (I4C) registered 2.04 crore cybercrime complaints in FY2024–25, with losses surpassing ₹22,000 crore — though I4C's own analyses suggest under 40% of incidents are formally reported. Applying that under-report multiplier, the true cost to Indian citizens is likely between ₹55,000 and ₹70,000 crore annually, or roughly 0.18% of GDP. For context, this exceeds the combined annual budget of all four metro police forces, India's annual flood-disaster economic impact in a non-cyclone year, and the Government of India's annual spend on the Pradhan Mantri Awas Yojana (urban)." },
      { heading: "The Victim Profile Has Shifted", text: "A persistent myth is that cyber victims are 'naive' or 'elderly'. VRIKAAN's data flatly contradicts this. The under-25 cohort is now the single largest victim group at 31% of complaints (up from 22% in 2023) — a complete inversion of the 2020 picture. The reason is two-fold: this group transacts almost exclusively via UPI, and they are disproportionately targeted by gig-work and influencer-fraud scams that simply did not exist five years ago. State-level data: Maharashtra leads at 26.7% of national losses (₹5,952 cr), followed by Karnataka (18.1%), Delhi-NCR (12.8%), Tamil Nadu (7.4%), and Gujarat (6.9%). Tier-2 cities (Nashik, Indore, Coimbatore, Chandigarh) are punching above their population weight, suggesting underreported risk concentration outside the metros." },
      { heading: "Attack Vector #1 — 'Digital Arrest'", text: "Victim receives a WhatsApp call from a uniformed individual claiming to be a CBI / RBI / NCB / Mumbai Police officer. They are told a parcel in their name (sometimes a SIM, sometimes 'narcotics', sometimes 'child abuse material') has been intercepted. The victim is kept on continuous video call for 6 to 38 hours under threat of immediate arrest. They are forced to transfer all liquid funds to a 'safe RBI account for verification'. VRIKAAN logged 9,400+ victim accounts in FY2025–26 with median loss ₹4.7 lakh. Max single loss: ₹6.8 crore (Mumbai industrialist, March 2026). 73% of victims were highly educated professionals. The myth that 'smart people don't fall for this' is wrong. Defence: never accept video calls from unknown numbers claiming law enforcement. Real Indian law enforcement does not arrest over video call. Use a pre-agreed family safe-word before any large transfer." },
      { heading: "Attack Vector #2 — UPI Collection-Request Fraud", text: "Attacker initiates a UPI collection request ('send money') rather than an autopay or transfer. The notification reads '₹X requested' but the victim, distracted, taps Approve thinking they are receiving the money. UPI UX makes the direction of the transfer ambiguous in a moment of inattention. The 'Approve' button is in the same colour and position regardless of direction. 38% of all UPI-rail losses in our data passed through collection-request abuse. Average loss per incident: ₹2,840 — small enough that many victims never report. Defence: read the screen twice. 'Pay' vs 'Collect' is the critical distinction. Disable collection requests entirely if you never use them (BHIM, GPay both support this in settings). VRIKAAN's UPI Lookup tool checks the recipient VPA against our scam-VPA registry before you approve." },
      { heading: "Attack Vector #3 — Deepfake Voice + Family Emergency", text: "A relative (typically son / daughter / grandchild) calls in distress: 'I've been in an accident', 'I've been arrested', 'I'm in hospital and need money urgently'. The voice is real — cloned from 6–10 seconds of audio scraped from Instagram Reels or WhatsApp status. AI voice clones from ElevenLabs, Resemble.AI, and open-source XTTS-v2 produce convincing Hindi / regional-language outputs. Emotional urgency disables analytical thinking. 17× increase in confirmed deepfake-voice incidents Jan 2025 → March 2026. Median loss: ₹85,000. 84% of victims were 50+ years old. Most attacks targeted families with children studying / working abroad. Defence: family safe-word — a single secret word every family member knows, used to verify emergencies. Always hang up and call the person back on their saved number. VRIKAAN's Deepfake Audio Detector identifies cloned voices with 87% accuracy on Indian-language samples." },
      { heading: "Attack Vector #4 — Loan-App Harassment", text: "Victim downloads a loan app (often from a non-Play-Store source), borrows ₹3,000–₹20,000 at predatory interest, then is unable to repay the inflated balance. Recovery agents access the victim's contact list (granted as a hidden permission), call every contact, threaten the victim's job/family/reputation, and increasingly use morphed nude images of the victim's female family members to extort payment. 23,800 loan-app related events in our data, up from 8,200 in 2024–25. 17 victims known to us died by suicide during the year — widely under-reported. Defence: never grant a loan app access to contacts, photos, or SMS. Borrow only from Play Store apps registered as NBFCs with the RBI. If harassed: report at cybercrime.gov.in, file an FIR, contact NCW for image-related abuse." },
      { heading: "Attack Vectors #5–7 — Investment, Gig, Phishing", text: "Investment scams (WhatsApp/Telegram 'VIP signal' groups with fake trading dashboards) account for 19% of all financial-loss events — average loss ₹2.84 lakh, second-highest per-victim category. 91% of dashboards traced back to 14 reusable templates hosted on Russian / Belarusian / Chinese infrastructure. Gig fraud (LinkedIn/WhatsApp 'rate Amazon products' offers requiring victims to send money for 'prepaid tasks') accounts for 14%, average loss ₹38,000, skewed 68% female. Phishing — SMS, email, social — accounts for 7% of confirmed financial loss but 38% of all events; AI-generated copy is now indistinguishable from real bank messaging, and phishing kits include real-time IP geofencing that defeats most threat-intel scanners." },
      { heading: "The Defensive Shift India Needs", text: "Enterprise security has spent 30 years building defence-in-depth: firewalls, IDS, EDR, SIEM, SOC. Indian households have access to almost none of this. The closest analogues — endpoint antivirus, mobile app stores' vetting — were designed for malware delivery, not for social-engineering at scale via WhatsApp. The defensive primitive India needs is the family safety unit, not the individual user account. A scam against one family member is a threat indicator for the rest. A senior parent's UPI app should default to extra confirmation steps. A child's account should never see dark-web monitoring panels. A working adult's password vault should be auditable by their spouse on death. VRIKAAN's Family Plan was designed around this primitive. We believe it will become the default architecture for consumer cyber defence in India by 2028." },
      { heading: "Seven Recommendations to Government", text: "1) Mandate sender-ID verification on bulk SMS. This single change would eliminate ~60% of smishing in India.  2) Public API for verifying CBI / RBI / NCB officer identity. End 'digital arrest' within months.  3) UPI collection-request opt-in by default, not opt-out. Most users do not use this feature.  4) Loan-app NBFC verification badge in Play Store listings — mandatory.  5) National data-broker registration with right-to-purge.  6) Cyber-safety in school curriculum Class 5 onwards.  7) Citizen recovery fund modelled on the UK's APP-fraud reimbursement scheme, funded by a small per-transaction levy on UPI / IMPS / NEFT." },
      { heading: "What the Next 12 Months Hold", text: "Three predictions, in descending order of confidence:  1) Deepfake video calls will overtake voice cloning as the primary AI-attack vector. Open-source real-time face-swap models crossed the consumer-device threshold in late 2025. By Diwali 2026, expect to see deepfake video versions of digital-arrest scams.  2) Loan-app fraud will move to UPI Lite and pre-approved credit lines. Predatory lenders are already piloting flows that bypass app stores entirely via UPI Lite, where credit is extended in-flow without an app install.  3) Regulator-impersonation will expand to GST and EPFO. Salary-class workers — particularly older PSU retirees — are the next target demographic. Expect 'EPFO verification' digital-arrest variants by H2 2026." },
      { heading: "Methodology & Disclosure", text: "VRIKAAN processes events from three sources: our installed user base (180k+ active accounts as of April 2026), our public scam-check API (~12M anonymous queries/year), and our scam-recovery hotline intake (8,400+ recovered cases since launch). Events are de-identified at ingestion, aggregated by pattern, and signature-matched against our threat library (curated by a 3-analyst SOC team based in Pune). Financial loss figures are self-reported by victims at recovery-flow intake; we apply no upward correction. VRIKAAN is a privately-funded Indian cybersecurity company headquartered in Pune. We sell consumer (Free, Standard ₹49/mo, Family ₹149/mo, Advanced ₹99/mo) and enterprise (₹199/mo+) subscriptions. This report is published under CC-BY 4.0 — republish freely with attribution. Press contact: hello@vrikaan.com" },
    ],
  },
  {
    id: 1,
