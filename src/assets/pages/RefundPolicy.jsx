    ...
    <div style={{ background: T.bg, minHeight: "100vh", color: T.white, fontFamily: "'Vrikaan Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "120px 24px 80px" }}>
        ...
        {[
          ...
          { title: "2. Refund Eligibility", content: "We offer a full refund if you request it within 7 days of your initial purchase. After the 7-day period, refunds will be considered on a case-by-case basis. To request a refund, please contact our support team at hello@vrikaan.com with your transaction details." },
          { title: "3. How to Request a Refund", content: "To initiate a refund, send an email to hello@vrikaan.com with the subject line 'Refund Request' and include: (1) Your registered email address, (2) Transaction ID or payment receipt, (3) Reason for the refund request. Our team will review and respond within 2-3 business days." },
