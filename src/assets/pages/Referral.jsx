          ...
          <>
            ...
            <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 16, padding: 28, marginBottom: 24 }}>
              ...
              <div style={{ display: "flex", gap: 10, marginBottom: 16 }}>
                <div style={{ flex: 1, padding: "14px 16px", background: "rgba(15,23,42,0.6)", borderRadius: 10, border: `1px solid ${T.border}`, fontSize: 18, fontWeight: 700, color: T.cyan, fontFamily: "'Vrikaan Mono',monospace", letterSpacing: 2 }}>{code}</div>
              ...
              <div style={{ padding: "10px 14px", background: "rgba(15,23,42,0.4)", borderRadius: 8, border: `1px solid ${T.border}`, wordBreak: "break-all", marginBottom: 16 }}>
                <span style={{ fontSize: 12, color: T.muted, fontFamily: "'Vrikaan Mono',monospace" }}>{referralLink}</span>
              </div>
            ...
            <div className="ref-stats-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 }}>
              <div style={{ padding: 20, background: T.card, borderRadius: 12, border: `1px solid ${T.border}`, textAlign: "center" }}>
                <div style={{ fontSize: 32, fontWeight: 800, color: T.cyan, fontFamily: "'Vrikaan Sans',sans-serif" }}>{referrals.length}</div>
                <div style={{ fontSize: 12, color: T.muted }}>Successful Referrals</div>
              </div>
              <div style={{ padding: 20, background: T.card, borderRadius: 12, border: `1px solid ${T.border}`, textAlign: "center" }}>
                <div style={{ fontSize: 32, fontWeight: 800, color: T.green, fontFamily: "'Vrikaan Sans',sans-serif" }}>{referrals.length * 10}</div>
            ...
            {referrals.length > 0 && (
              <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 16, padding: 28, marginBottom: 24 }}>
                <h3 style={{ fontSize: 16, fontWeight: 700, color: T.white, marginBottom: 16, fontFamily: "'Vrikaan Sans',sans-serif" }}>Recent Referrals</h3>
            ...
            <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 16, padding: 28 }}>
              <h3 style={{ fontSize: 16, fontWeight: 700, color: T.white, marginBottom: 16, fontFamily: "'Vrikaan Sans',sans-serif" }}>Reward Tiers</h3>
              {rewards.map((r, i) => (
