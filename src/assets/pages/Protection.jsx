    ...
    <div style={{ background: T.bg, minHeight: "100vh", color: T.white, fontFamily: "'Hanken Grotesk', sans-serif" }}>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "120px 24px 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          <h1 style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: "clamp(36px, 4vw, 48px)", fontWeight: 700, letterSpacing: "-0.03em", margin: "0 0 16px" }}>Multi-Layer <span style={{ background: "linear-gradient(135deg, #6366f1, #14e3c5)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Protection</span></h1>
        ...
        <div className="resp-grid-2" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 20, marginBottom: 64 }}>
          {layers.map((l, i) => (
            <div key={i} style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 16, padding: "32px 28px", position: "relative", overflow: "hidden", transition: "all 0.3s" }}>
              ...
              <h3 style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 19, fontWeight: 600, margin: "0 0 10px" }}>{l.title}</h3>
        ...
        <div className="resp-grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 64 }}>
          {[{ val: "AI", label: "Powered Detection", color: T.cyan }, { val: "<2s", label: "Scan Time", color: T.accent }, { val: "24/7", label: "Always-on", color: "#22c55e" }, { val: "EN+हिं", label: "Bilingual", color: T.ember }].map((s, i) => (
            <div key={i} style={{ textAlign: "center", padding: "28px 16px", background: T.card, border: `1px solid ${T.border}`, borderRadius: 14 }}>
              <div style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 32, fontWeight: 800, color: s.color }}>{s.val}</div>
        ...
        <div style={{ textAlign: "center", padding: "48px 32px", background: "linear-gradient(135deg, rgba(99,102,241,0.06), rgba(20,227,197,0.03))", border: `1px solid rgba(99,102,241,0.1)`, borderRadius: 20 }}>
          <h2 style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 28, fontWeight: 700, margin: "0 0 12px" }}>Activate Your Shield</h2>
