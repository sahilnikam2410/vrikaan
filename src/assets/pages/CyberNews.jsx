    ...
    <div style={{ background: T.bg, minHeight: "100vh", fontFamily: "'Vrikaan Sans', sans-serif" }}>
      ...
      <div style={{ background: "linear-gradient(90deg, rgba(239,68,68,0.15) 0%, rgba(99,102,241,0.10) 50%, rgba(239,68,68,0.15) 100%)", borderBottom: `1px solid ${T.border}`, overflow: "hidden", whiteSpace: "nowrap", padding: "10px 0", marginTop: 80 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, paddingLeft: 16 }}>
          <span style={{ background: T.red, color: "#fff", fontFamily: "'Vrikaan Sans', sans-serif", fontWeight: 700, fontSize: 11, padding: "3px 10px", borderRadius: 4, letterSpacing: 1, flexShrink: 0, animation: "pulse 2s infinite" }}>LIVE THREATS</span>
          <div style={{ overflow: "hidden", flex: 1 }}>
            <div ref={tickerRef} style={{ display: "inline-block", whiteSpace: "nowrap", transform: `translateX(${tickerOffset % (tickerWidth + 600)}px)`, fontFamily: "'Vrikaan Mono', monospace", fontSize: 12, color: T.red, letterSpacing: 0.3 }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <h1 style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: "clamp(32px, 5vw, 48px)", fontWeight: 700, color: T.white, margin: 0, lineHeight: 1.1 }}>
        ...
        <div style={{ maxWidth: 600, margin: "0 auto 32px", position: "relative" }}>
          ...
          <input
            ...
            style={{ width: "100%", boxSizing: "border-box", padding: "14px 16px 14px 44px", background: T.card, border: `1px solid ${T.border}`, borderRadius: 12, color: T.white, fontSize: 14, fontFamily: "'Vrikaan Sans', sans-serif", outline: "none", transition: "border-color 0.2s" }}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: 32, alignItems: "start" }}>
          ...
          <div>
            ...
            {breakingArticle && (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                  <span style={{ background: T.red, color: "#fff", fontFamily: "'Vrikaan Sans', sans-serif", fontWeight: 700, fontSize: 11, padding: "4px 12px", borderRadius: 4, letterSpacing: 1, animation: "pulse 2s infinite" }}>BREAKING</span>
                  <span style={{ background: severityBg[breakingArticle.severity], color: severityColors[breakingArticle.severity], fontFamily: "'Vrikaan Mono', monospace", fontSize: 11, fontWeight: 600, padding: "4px 10px", borderRadius: 4 }}>{breakingArticle.severity.toUpperCase()}</span>
                  <span style={{ color: T.muted, fontSize: 12, fontFamily: "'Vrikaan Mono', monospace" }}>{breakingArticle.date}</span>
                </div>
                <h2 style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 24, fontWeight: 700, color: T.white, margin: "0 0 12px", lineHeight: 1.3 }}>{breakingArticle.title}</h2>
                <p style={{ color: T.muted, fontSize: 15, lineHeight: 1.6, margin: "0 0 16px" }}>{breakingArticle.summary}</p>
                <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
                  <span style={{ color: categoryColors[breakingArticle.category] || T.accent, fontSize: 12, fontWeight: 600, fontFamily: "'Vrikaan Sans', sans-serif", background: `${categoryColors[breakingArticle.category] || T.accent}15`, padding: "4px 10px", borderRadius: 6 }}>{breakingArticle.category}</span>
                ...
                {expandedArticle === breakingArticle.id && (
                  <div style={{ marginTop: 24, paddingTop: 24, borderTop: `1px solid ${T.border}` }}>
                    {breakingArticle.fullContent.split("\n\n").map((p, i) => (
                      <p key={i} style={{ color: "rgba(241,245,249,0.85)", fontSize: 14, lineHeight: 1.8, margin: "0 0 16px", fontFamily: "'Vrikaan Sans', sans-serif" }}>{p}</p>
                    ))}
                  </div>
                )}
              </div>
              ...
              return (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12, flexWrap: "wrap" }}>
                    <span style={{ background: severityBg[article.severity], color: severityColors[article.severity], fontFamily: "'Vrikaan Mono', monospace", fontSize: 10, fontWeight: 700, padding: "3px 8px", borderRadius: 4, letterSpacing: 0.5 }}>{article.severity.toUpperCase()}</span>
                    <span style={{ color: categoryColors[article.category] || T.accent, fontSize: 11, fontWeight: 600, fontFamily: "'Vrikaan Sans', sans-serif", background: `${categoryColors[article.category] || T.accent}12`, padding: "3px 8px", borderRadius: 4 }}>{article.category}</span>
                    <span style={{ color: T.muted, fontSize: 11, fontFamily: "'Vrikaan Mono', monospace", marginLeft: "auto" }}>{article.date}</span>
                  </div>
                  <h3 style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 18, fontWeight: 700, color: T.white, margin: "0 0 10px", lineHeight: 1.3 }}>{article.title}</h3>
                  ...
                  {isExpanded && (
                    <div style={{ marginTop: 20, paddingTop: 20, borderTop: `1px solid ${T.border}` }}>
                      {article.fullContent.split("\n\n").map((p, i) => (
                        <p key={i} style={{ color: "rgba(241,245,249,0.85)", fontSize: 14, lineHeight: 1.8, margin: "0 0 14px", fontFamily: "'Vrikaan Sans', sans-serif" }}>{p}</p>
                      ))}
                    </div>
                  )}
                </div>
            ...
            {filteredArticles.length === 0 && (
              <div style={{ textAlign: "center", padding: "60px 20px" }}>
                ...
                <h3 style={{ fontFamily: "'Vrikaan Sans', sans-serif", color: T.white, fontSize: 20, margin: "0 0 8px" }}>No articles found</h3>
          ...
          <div style={{ position: "sticky", top: 120 }}>
            ...
            <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 14, padding: 24, marginBottom: 24 }}>
              <h3 style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 16, fontWeight: 700, color: T.white, margin: "0 0 18px", display: "flex", alignItems: "center", gap: 8 }}>
                ...
                {trendingTopics.map((topic) => {
                  ...
                  return (
                    <button key={topic.label}
                      ...
                      style={{ padding: "5px 12px", borderRadius: 8, border: `1px solid ${isHovered ? "rgba(99,102,241,0.3)" : T.border}`, background: isHovered ? "rgba(99,102,241,0.1)" : "transparent", color: isHovered ? T.accent : T.muted, fontSize: size, fontWeight: 500, fontFamily: "'Vrikaan Sans', sans-serif", cursor: "pointer", transition: "all 0.2s" }}
                    >
                ...
                return (
                  <div key={sev} style={{ marginBottom: 14 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                      <span style={{ color: severityColors[sev], fontSize: 12, fontWeight: 600, fontFamily: "'Vrikaan Sans', sans-serif" }}>{sev}</span>
                      <span style={{ color: T.muted, fontSize: 12, fontFamily: "'Vrikaan Mono', monospace" }}>{count} articles</span>
                    </div>
              ...
              {sources.slice(0, 6).map((src) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span style={{ color: T.cyan, fontSize: 12, fontFamily: "'Vrikaan Mono', monospace", fontWeight: 600 }}>{count}</span>
                  </div>
                );
              })}
            </div>
            ...
            <div style={{ background: "linear-gradient(135deg, rgba(99,102,241,0.1) 0%, rgba(17,24,39,0.8) 100%)", border: `1px solid rgba(99,102,241,0.15)`, borderRadius: 14, padding: 24 }}>
              <h3 style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 16, fontWeight: 700, color: T.white, margin: "0 0 8px" }}>
                Threat Intel Digest
              </h3>
              ...
              {newsletterSubmitted ? (
                ...
                <form onSubmit={handleNewsletter} style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  <input
                    ...
                    style={{ padding: "10px 14px", background: "rgba(17,24,39,0.6)", border: `1px solid ${T.border}`, borderRadius: 8, color: T.white, fontSize: 13, fontFamily: "'Vrikaan Sans', sans-serif", outline: "none" }}
                    onFocus={(e) => (e.target.style.borderColor = T.accent)} onBlur={(e) => (e.target.style.borderColor = T.border)}
                  />
                  <button type="submit" style={{ padding: "10px 0", background: T.accent, border: "none", borderRadius: 8, color: "#fff", fontSize: 13, fontWeight: 600, fontFamily: "'Vrikaan Sans', sans-serif", cursor: "pointer", transition: "opacity 0.2s", letterSpacing: 0.5 }}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginTop: 48, padding: "24px 0", borderTop: `1px solid ${T.border}` }}>
          {[
            ...
            <div key={i} style={{ textAlign: "center", padding: "16px 12px" }}>
              ...
              <div style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 28, fontWeight: 700, color: stat.color }}>{stat.value}</div>
