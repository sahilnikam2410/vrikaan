...
const SocDashboard = lazy(() => import("./assets/pages/SocDashboard.jsx"));
      ...
      <Suspense fallback={<PageSkeleton />}>
        <PageTransition>
          <Routes>
            ...
            <Route path="/scam-recovery" element={<ScamRecovery />} />
            ...
            <Route path="/whatsapp-audit" element={<WhatsAppAudit />} />
            <Route path="/group-audit" element={<WhatsAppAudit />} />
