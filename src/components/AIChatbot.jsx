    ...
    <div id="vrikaan-chat" style={{
      ...
      {view === "setup" && (
        <div style={{ flex: 1, padding: 20, overflowY: "auto" }}>
          <h3 style={{ fontSize: 16, fontWeight: 700, color: T.white, fontFamily: "'Vrikaan Sans'", marginBottom: 8 }}>Settings</h3>
      ...
      {view === "credits" && (
        <div style={{ flex: 1, padding: 20, overflowY: "auto" }}>
          <h3 style={{ fontSize: 16, fontWeight: 700, color: T.white, fontFamily: "'Vrikaan Sans'", marginBottom: 16 }}>AI Credits</h3>
            ...
            {messages.map((m, i) => (
              <div key={i} style={{ display: "flex", flexDirection: m.role === "user" ? "row-reverse" : "row", gap: 8, alignItems: "flex-start", animation: "msgIn 0.35s cubic-bezier(0.16,1,0.3,1) both" }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 10, color: "rgba(148,163,184,0.4)", marginTop: 4, fontFamily: "'Vrikaan Mono', monospace" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: 4 }}>
                {quickActions.map((q, i) => (
                  <button key={i} onClick={() => { setInput(q); setTimeout(() => { setInput(q); }, 50); }} style={{
                    ...
                    fontFamily: "'Vrikaan Sans'", transition: "all 0.2s",
                  }}>
                    {q}
                  </button>
                ))}
          ...
          <div style={{ padding: "10px 14px", borderTop: `1px solid ${T.border}`, display: "flex", gap: 8, alignItems: "center" }}>
            ...
            <input
              ...
              style={{
                ...
                fontFamily: "'Vrikaan Sans'", outline: "none",
              }}
            />
      ...
      {showPaywall && selectedPlan && (
        <div style={{
          ...
          <h3 style={{ fontSize: 18, fontWeight: 800, color: T.white, fontFamily: "'Vrikaan Sans'", marginBottom: 4 }}>
