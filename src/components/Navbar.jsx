    ...
    <>
      <nav style={{
        ...
        <Link to="/" style={{
          ...
          fontFamily: "'Vrikaan Sans', sans-serif", display: "flex", alignItems: "center", gap: 10,
        }}>
          <img
              ...
              <div ref={dropRef} style={{ position: "relative" }}>
                ...
                {toolsOpen && (
                  <div style={{
                    ...
                    <Link to="/tools" onClick={() => setToolsOpen(false)} style={{ display: "block", textAlign: "center", marginTop: 10, padding: "10px", borderRadius: 8, color: T.cyan, fontWeight: 700, fontSize: 13, textDecoration: "none", background: `${T.cyan}12`, border: `1px solid ${T.cyan}33` }}>Browse all tools →</Link>
                  </div>
                )}
              </div>
        ...
        <div className="nav-desktop-auth" style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div ref={searchRef} style={{ position: "relative" }}>
            ...
            >
              ...
              <kbd style={{ fontSize: 10, padding: "2px 5px", borderRadius: 4, background: "rgba(148,163,184,0.08)", border: `1px solid ${T.border}`, color: T.muted, fontFamily: "'Vrikaan Mono', monospace" }}>Ctrl K</kbd>
            </button>
          ...
          {user ? (
            <>
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span style={{ position: "absolute", top: 2, right: 2, minWidth: 16, height: 16, borderRadius: 8, background: "#ef4444", border: `2px solid ${T.bg}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 9, fontWeight: 700, color: "#fff", padding: "0 3px", fontFamily: "'Vrikaan Sans'" }}>
                    {unreadCount}
                  </span>
                )}
                ...
                {notifOpen && (
                  <div style={{
                    ...
                    <div style={{ padding: "14px 16px", borderBottom: `1px solid ${T.border}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span style={{ fontFamily: "'Vrikaan Sans', sans-serif", fontSize: 13, fontWeight: 700, color: T.white }}>
              ...
              {user.plan === "family" && (
                <Link to="/family" style={{
                  ...
                  fontWeight: 700, fontFamily: "'Vrikaan Sans', sans-serif",
                  display: "inline-flex", alignItems: "center", gap: 6,
          ...
          {user && (
            <>
              <button onClick={() => setMobileToolsOpen(!mobileToolsOpen)} style={{
                ...
                fontFamily: "'Vrikaan Sans', sans-serif", padding: "12px 24px",
